...
import net.sf.l2j.gameserver.handler.itemhandlers.AdenaToGoldBar;
import net.sf.l2j.gameserver.handler.itemhandlers.Aio;
...
import net.sf.l2j.gameserver.handler.itemhandlers.ClanFull;
...
import net.sf.l2j.gameserver.handler.itemhandlers.GoldBarToAdena;
...
import net.sf.l2j.gameserver.handler.itemhandlers.Nobless;
...
import net.sf.l2j.gameserver.handler.itemhandlers.Vip;
...
public class ItemHandler
{
	...
	protected ItemHandler()
	{
		...
		registerItemHandler(new Nobless());
		...
		registerItemHandler(new AdenaToGoldBar());
		registerItemHandler(new GoldBarToAdena());
		registerItemHandler(new Vip());
	}
