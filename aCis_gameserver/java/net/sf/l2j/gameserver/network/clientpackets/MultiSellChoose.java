			...
			if (entry.getId() == _entryId)
			{
				...
				for (Ingredient e : ingredientsList)
				{
					...
					else
					{
						...
						if (inv.getInventoryItemCount(e.getItemId(), (list.getMaintainEnchantment() || (e.getEnchantLevel() > 0)) ? e.getEnchantLevel() : -1, false) < ((Config.ALT_BLACKSMITH_USE_RECIPES || !e.getMaintainIngredient()) ? e.getItemCount() * _amount : e.getItemCount()))
						{
					...
					else
					{
						...
						if (Config.ALT_BLACKSMITH_USE_RECIPES || !e.getMaintainIngredient())
						{
							...
							else
							{
								...
								if (list.getMaintainEnchantment() || (e.getEnchantLevel() > 0)) // if (list.getMaintainEnchantment())
								{
					...
					else
					{
						...
						else
						{
							for (int i = 0; i < (e.getItemCount() * _amount); i++)
							{
								...
								if (product != null && list.getMaintainEnchantment() || product != null && (e.getEnchantLevel() > 0)) //if (product != null && list.getMaintainEnchantment())
								{
