...
public class Clan
{
	...
	public boolean levelUpClan(Player player)
	{
		...
		switch (_level)
		{
			...
			case 5:// upgrade to 6
				if (_reputationScore >= Config.CLAN_LVL6_REPUTATION && getMembersCount() >= Config.CLAN_LVL6_MEMBERS)
				{
					takeReputationScore(Config.CLAN_LVL6_REPUTATION);
			...
			case 6:// upgrade to 7
				if (_reputationScore >= Config.CLAN_LVL7_REPUTATION && getMembersCount() >= Config.CLAN_LVL7_MEMBERS)
				{
					takeReputationScore(Config.CLAN_LVL7_REPUTATION);
			...
			case 7:// upgrade to 8
				if (_reputationScore >= Config.CLAN_LVL8_REPUTATION && getMembersCount() >= Config.CLAN_LVL8_MEMBERS)
				{
					takeReputationScore(Config.CLAN_LVL8_REPUTATION);
