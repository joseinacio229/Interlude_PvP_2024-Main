...
public abstract class AbstractOlympiadGame
{
	...
	protected static final void buffPlayer(Player player)
	{
	    ...
	    // Buff para todos los jugadores: Shield 3 
	    skill = SkillTable.getInstance().getInfo(1040, 3); // Shield 3
	    if (skill != null)
	    {
	        skill.getEffects(player, player);
	    ...
	    // Buff para todos los jugadores: Magic Barrier 2 
	    skill = SkillTable.getInstance().getInfo(1036, 2); // Magic Barrier 2
	    if (skill != null)
	    {
	        skill.getEffects(player, player);
	        player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOU_FEEL_S1_EFFECT).addSkillName(1085));
	    ...
	    {
	        // Buff solo para clase mago: Acumen 3
	        skill = SkillTable.getInstance().getInfo(1085, 3); // Acumen 3
	        if (skill != null)
	        {
	            skill.getEffects(player, player);
	            player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOU_FEEL_S1_EFFECT).addSkillName(1085));
	    ...
	    if (!player.isMageClass())
	    {
	        skill = SkillTable.getInstance().getInfo(1086, 2); // Haste 2
	        if (skill != null)
	        {
	            skill.getEffects(player, player);
