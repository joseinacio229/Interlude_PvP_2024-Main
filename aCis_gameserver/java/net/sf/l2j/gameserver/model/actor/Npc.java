...
import net.sf.l2j.gameserver.data.FakePcsTable;
		...
		for (DropCategory cat : list)
		{
			...
			for (DropData drop : cat.getAllDrops())
			{
				...
				if (drop.getItemId() == 57) {
				    chance = (drop.getChance() * Config.RATE_DROP_ADENA) / 10000;
				} else if (drop.getItemId() == 6360 || drop.getItemId() == 6361 || drop.getItemId() == 6362) {
				    chance = (drop.getChance() * Config.RATE_DROP_SEAL_STONES) / 10000;
				} else {
