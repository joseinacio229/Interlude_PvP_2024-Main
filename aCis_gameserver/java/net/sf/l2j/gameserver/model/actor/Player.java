...
public final class Player extends Playable
{
	...
	private int originalArmorSkinId;
	private int originalWeaponSkinId;
	private int originalHairSkinId;
	private int originalFaceSkinId;
	private int originalShieldSkinId;
	...
	{
	    // Verificar si el jugador está en "trying skin"
	    if (isTryingSkin()) 
		{
	        sendMessage("You cannot log out while trying a skin. Please wait for the trial to end.");
	        sendPacket(ActionFailed.STATIC_PACKET);
	        return; // Salir de la función para evitar la desconexión
	    }
...
//Dressme -------------------------------------------------------------------------------------------------------------------------
	...
	public int getOriginalArmorSkinId() {
	    return originalArmorSkinId;
	}

	public void setOriginalArmorSkinId(int id) {
	    this.originalArmorSkinId = id;
	}

	public int getOriginalWeaponSkinId() {
	    return originalWeaponSkinId;
	}

	public void setOriginalWeaponSkinId(int id) {
	    this.originalWeaponSkinId = id;
	}

	public int getOriginalHairSkinId() {
	    return originalHairSkinId;
	}

	public void setOriginalHairSkinId(int id) {
	    this.originalHairSkinId = id;
	}

	public int getOriginalFaceSkinId() {
	    return originalFaceSkinId;
	}

	public void setOriginalFaceSkinId(int id) {
	    this.originalFaceSkinId = id;
	}

	public int getOriginalShieldSkinId() {
	    return originalShieldSkinId;
	}

	public void setOriginalShieldSkinId(int id) {
	    this.originalShieldSkinId = id;
	}
	...
	// Este método ya existe en tu clase Player
	public boolean getGainXpSpEnable() {
	    return _gainXpSpEnable; // Devuelve si está permitido o no ganar XP/SP
	}

	// Este método también ya lo tienes
	public void setGainXpSpEnable(boolean value) {
	    _gainXpSpEnable = value; // Establece si se puede o no ganar XP/SP
	}

	// Método que determina si el jugador puede ganar XP/SP
	public boolean canGainXpSp()
	{
	    // Si la ganancia de XP/SP está bloqueada, no puede ganar XP/SP, sin importar si es VIP
	    if (!getGainXpSpEnable()) {
	        return false;
	    }

	    // Otras condiciones adicionales podrían ir aquí (si es necesario, como reglas especiales para VIP)
	    
	    return true; // Si no está bloqueado, puede ganar XP/SP
	}
	...
	{
	    // Verifica si el jugador puede ganar XP/SP
	    if (!canGainXpSp()) {
	        // Si no puede ganar XP/SP, muestra un mensaje y no añade XP/SP
	        sendMessage("XP/SP gain is currently disabled.");
	        return; // Sal del método sin añadir XP/SP
	    }
	    
	    // Si puede ganar XP/SP, procede normalmente
